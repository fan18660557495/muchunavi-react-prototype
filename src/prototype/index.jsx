...
export const secondaryScreens = [
  ...
  { id: 'mypage-benefits', title: '会員特典', component: window.MU_MyBenefits },
  { id: 'mypage-pt-detail', title: 'ポイント明細', component: window.MU_MyPointDetail },
  { id: 'mypage-muchupon-history', title: 'muchuポン購入履歴', component: window.MU_MyMuchuponHistory },
